"""The transaction behind an admin's review: decision, points and audit together."""
...
class SqlAlchemyRunReviewUnitOfWork:
    ...
    def __enter__(self) -> SqlAlchemyRunReviewUnitOfWork:
