...
- [ ] `CONSENT_VERSION` = v1 — โอเคไหม · **ถ้าแก้ถ้อยคำหลัง launch ต้องขยับเป็น v2**
      (สมาชิกที่ยินยอมข้อความเก่าจะถูกถามใหม่ ซึ่งถูกต้องแล้ว) — ตอนนี้ยังไม่ต้องขยับ
      เพราะยังไม่มีใครกดยินยอมข้อความเดิมใน prod ถ้ามีแล้วให้ขยับด้วย
